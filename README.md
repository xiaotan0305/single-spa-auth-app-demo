...
[![npm version](https://img.shields.io/npm/v/single-spa-auth-app-demo.svg?style=flat-square)](https://www.npmjs.org/package/single-spa-auth-app-demo)
[![](https://data.jsdelivr.com/v1/package/npm/single-spa-auth-app-demo/badge)](https://www.jsdelivr.com/package/npm/single-spa-auth-app-demo)

# single-spa-auth-app-demo
...
```json
{
  "name": "single-spa-auth-app-demo",
  "version": "0.1.2",
  "description": "Vue application with login form for be included in a single-spa application as registered app.",
  "main": "dist/single-spa-auth-app-demo.umd.js",
  "scripts": {
    "build": "vue-cli-service build --target lib --formats umd --name single-spa-auth-app-demo src/singleSpaEntry.js",
  ...
  "repository": {
    "type": "git",
    "url": "https://github.com/jualoppaz/single-spa-auth-app-demo.git"
  },
  "keywords": [
    "single-spa",
    "login",
  ...
  "bugs": {
    "url": "https://github.com/jualoppaz/single-spa-auth-app-demo/issues"
  },
  "homepage": "https://github.com/jualoppaz/single-spa-auth-app-demo#readme"
}
```
...
module.exports = {
  ...
  configureWebpack: {
    output: {
      library: 'single-spa-auth-app-demo',
      libraryTarget: 'umd',
      filename: 'single-spa-auth-app-demo.js',
